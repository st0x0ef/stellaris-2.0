...
- Right-click with the tablet in hand to open it. 
- Sneak and right-click a **block** to jump straight to that block's page. 
- In your inventory, pick up an item and drop it onto the tablet to open the page of that item. 



**Applications** 

- **Wiki** : these pages. Every machine, item, mob and rocket part of the mod. 
