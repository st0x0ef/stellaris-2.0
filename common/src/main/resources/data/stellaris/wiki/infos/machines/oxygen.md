...
The room is filled by air spreading from the distributor through every block you could walk through, and it must respect three rules : 
...
While powered, it adds its own 3 x 3 chunks to the area a distributor is allowed to fill, as long as it stands inside an area that is already allowed. Air inside those chunks does not count against the distributor's own 3 x 3 budget, so chaining several of them runs air down a long corridor or across a big base with no total limit. An unpowered propagator adds nothing. 
