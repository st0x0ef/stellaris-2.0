...
iconType: item
associatedBlocks: [stellaris:fuel_refinery]
---

The Fuel Refinery is the machine that turns [ref=stellaris:items/oil]Oil[ref] into the two fuels of the mod.

[image=stellaris:textures/wiki/rendered_blocks/fuel_refinery width=96 height=96]
...
- Diesel Production : 5 mB/t 
- Tank Capacity : 10 000 mB each 
- Internal Buffer : 12 800 FE

[image=stellaris:textures/gui/fuel_refinery width=96 height=119]

[item=stellaris:fuel_refinery onlyIcon]
