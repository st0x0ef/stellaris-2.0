...
A full set is made of four pieces : 
- Helmet 
- Chestplate 
- Leggings 
- Boots 
...
The bare suit is life support, not armor : it stops no damage on its own. Protection comes from a Damage Protection module. It is repaired with titanium. 

Modules of the same kind replace each other, so installing a higher tier always upgrades the one already fitted. 
...
Charge the helmet by placing it in the output slot of a [ref=stellaris:machines/power_bank]Power Bank[ref]. 

**Chestplate** 
- Diesel tank module, three tiers : 1 000, 2 000 or 3 000 mB. 
- Hydrogen tank module, three tiers : 1 000, 2 000 or 3 000 mB. 
These carry the fuel your boots burn. 

**Boots** 
- Jet module, three tiers : lets you fly. Tier 1 burns 8 mB of fuel per second and climbs at 0.35 blocks per tick, tier 2 burns 5 and climbs at 0.5, tier 3 burns 3 and climbs at 0.7. Higher tiers both last longer and fly better. 

**Any piece** 
- Damage Protection module, three tiers : gives that piece the armor of iron, diamond or netherite. Each module covers a single piece, so a full set takes four.
