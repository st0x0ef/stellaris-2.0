...
iconType: item
associatedBlocks: [stellaris:pumpjack]
---

The Pumpjack extracts [ref=stellaris:items/oil]Oil[ref] out of the ground. It is an essential machine for space exploration, since oil is what becomes the fuel that lifts your rocket.

[image=stellaris:textures/wiki/rendered_blocks/pumpjack width=96 height=96]
...
The oil of a chunk is a **finite reserve**. Once a chunk is dry, the Pumpjack stops and you have to move to another deposit. 
...
[item=stellaris:pumpjack onlyIcon]
