...
public class SolarPanelScreen extends AbstractContainerScreen<SolarPanelMenu> {
    ...
    protected void renderTooltip(GuiGraphics guiGraphics, int x, int y) {
        ...
        energyGauge.renderTooltips(guiGraphics, x, y, font, list -> list.add(ClientTooltipComponent.create(Component.translatable("gauge_text.stellaris.max_generation", getMenu().getBlockEntity().getEnergyGeneratedPT()).getVisualOrderText())));
    }
