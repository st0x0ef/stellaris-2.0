...
public class FuelRefineryScreen extends AbstractContainerScreen<FuelRefineryMenu> {
    ...
    protected void init() {
        ...
        FluidOutputManagerWidget fluidOutputManagerWidget = new FluidOutputManagerWidget(leftPos + imageWidth, topPos, 160, 60, new FluidOutputManager(blockEntity), this);
