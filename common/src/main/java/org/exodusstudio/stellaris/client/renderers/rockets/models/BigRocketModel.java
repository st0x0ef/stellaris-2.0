...
public class BigRocketModel extends RocketModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(IdentifierUtils.id("big_rocket"), "main");

	public BigRocketModel(EntityModelSet context) {
