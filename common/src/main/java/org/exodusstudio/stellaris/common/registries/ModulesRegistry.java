...
public class ModulesRegistry {
    ...
    public static final RegistrySupplier<NightVisionModuleItem> NIGHT_VISION_MODULE = StellarisRegistries.SPACE_SUIT_MODULES.register(IdentifierUtils.id("night_vision_module"), ItemsRegistry.SPACE_SUIT_NIGHT_VISION_MODULE);
