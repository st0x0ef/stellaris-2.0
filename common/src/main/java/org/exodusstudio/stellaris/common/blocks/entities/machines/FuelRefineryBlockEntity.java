...
public class FuelRefineryBlockEntity extends BaseEnergyContainerBlockEntity implements FluidProvider.BLOCK {
    ...
    public void tick(Level level, BlockState state) {
        FluidUtil.moveFluidToItem(0, inputTank, 1, 1, items, 1000);
        FluidUtil.moveFluidToItem(0, outputFuelTank, 2, 2, items, 1000);
        FluidUtil.moveFluidToItem(0, outputDieselTank, 4, 4, items, 1000);

        FluidUtil.moveFluidFromItem(0, 0, 0, items, inputTank, 1000);
