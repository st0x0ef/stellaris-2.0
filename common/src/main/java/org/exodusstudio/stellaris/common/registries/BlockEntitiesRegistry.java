...
public class BlockEntitiesRegistry {
    ...
    public static final Supplier<BlockEntityType<CargoUnloaderBlockEntity>> CARGO_UNLOADER = BLOCK_ENTITY_TYPE.register("cargo_unloader",
    ...
    public static final Supplier<BlockEntityType<EngineeringStationBlockEntity>> ENGINEERING_STATION = BLOCK_ENTITY_TYPE.register("engineering_station",
    ...
    public static final Supplier<BlockEntityType<SlidingDoorBlockEntity>> SLIDING_DOOR = BLOCK_ENTITY_TYPE.register("sliding_door",
            () -> new BlockEntityType<>(SlidingDoorBlockEntity::new, Set.of(BlocksRegistry.TITANIUM_DOOR.block().get())));
    ...
    public static final Supplier<BlockEntityType<OxygenDistributorBlockEntity>> OXYGEN_DISTRIBUTOR = BLOCK_ENTITY_TYPE.register("oxygen_distributor",
    ...
    public static final Supplier<BlockEntityType<AntennaBlockEntity>> ANTENNA = BLOCK_ENTITY_TYPE.register("antenna",
            () -> new BlockEntityType<>(AntennaBlockEntity::new, Set.of(BlocksRegistry.ANTENNA.block().get())));

    public static final Supplier<BlockEntityType<LaboratoryBlockEntity>> LABORATORY = BLOCK_ENTITY_TYPE.register("laboratory",
