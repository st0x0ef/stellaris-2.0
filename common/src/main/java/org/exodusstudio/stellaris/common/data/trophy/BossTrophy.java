...
public record BossTrophy(Identifier texture, Vector3f rotation, List<String> renderedPartPath, List<String> ignoredPart, ModelLayerLocation modelLayerLocation) {
