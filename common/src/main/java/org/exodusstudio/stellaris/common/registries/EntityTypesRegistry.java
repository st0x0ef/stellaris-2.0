...
public class EntityTypesRegistry {
    ...
    public static final RegistrySupplier<EntityType<RocketEntity>> ROCKET = ENTITY_TYPE.register("rocket",
            () -> EntityType.Builder.of(RocketEntity::new, MobCategory.MISC).sized(1.1f, 4.4f).fireImmune().build(ResourceLocationUtils.resourceKey(Registries.ENTITY_TYPE, "rocket")));
}
