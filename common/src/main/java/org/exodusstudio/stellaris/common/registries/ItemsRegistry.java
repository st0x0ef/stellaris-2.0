...
public final class ItemsRegistry {
    ...
    public static RegistrySupplier<Item> item(String name, Item.Properties properties) {
        return item(name, properties.arch$tab(CreativeTabsRegistry.STELLARIS_MAIN), Item::new);
    }
