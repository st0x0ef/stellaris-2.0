...
public final class ItemsRegistry {
    ...
    public static final RegistrySupplier<RocketItem> ROCKET = item("rocket", new Item.Properties().arch$tab(CreativeTabsRegistry.STELLARIS_MAIN).component(DataComponentsRegistry.ROCKET_MODULES.get(), RocketModules.empty()), (p) -> new RocketItem(p));
