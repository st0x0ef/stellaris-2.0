...
public final class ItemsRegistry {
    ...
    public static final RegistrySupplier<NightVisionModuleItem> SPACE_SUIT_NIGHT_VISION_MODULE = item("space_suit_night_vision_module", NightVisionModuleItem::new);
    ...
    public static final RegistrySupplier<SpawnEggItem> HEART_OF_LUNA_SPAWN_EGG = item("heart_of_luna_spawn_egg", p -> new SpawnEggItem(p.spawnEgg(EntityTypesRegistry.HEART_OF_LUNA.get())));
