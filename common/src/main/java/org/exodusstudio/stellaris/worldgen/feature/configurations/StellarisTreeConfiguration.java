...
public class StellarisTreeConfiguration extends TreeConfiguration {

    public static final Codec<StellarisTreeConfiguration> CODEC = RecordCodecBuilder.create(inst -> inst.group(
    ...
    ).apply(inst, StellarisTreeConfiguration::new));
    ...
    protected StellarisTreeConfiguration(BlockStateProvider trunkProvider, BlockStateProvider foliageProvider, BlockStateProvider vineProvider, BlockStateProvider hangingProvider, BlockStateProvider trunkFruitProvider, BlockStateProvider altFoliageProvider, int minHeight, int maxHeight, List<TreeDecorator> decorators) {
    ...
    public static class Builder {
        ...
        public StellarisTreeConfiguration build() {
            return new StellarisTreeConfiguration(this.trunkProvider, this.foliageProvider, this.vineProvider, this.hangingProvider, this.trunkFruitProvider, this.altFoliageProvider, this.minHeight, this.maxHeight, this.decorators);
        }
    }
}
