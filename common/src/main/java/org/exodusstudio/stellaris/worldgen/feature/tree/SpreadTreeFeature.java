...
public class SpreadTreeFeature extends StellarisTreeFeature<SpreadTreeConfiguration>{
    public SpreadTreeFeature(Codec<SpreadTreeConfiguration> codec) {
        super(codec);
    }
    ...
    protected boolean doPlace(WorldGenLevel world, RandomSource random, BlockPos startPos, BiConsumer<BlockPos, BlockState> roots, BiConsumer<BlockPos, BlockState> logs, FoliagePlacer.FoliageSetter leaves, SpreadTreeConfiguration configBase)
    {
        SpreadTreeConfiguration config = configBase;
